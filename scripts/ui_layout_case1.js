/*
  ...
  TITLE:   UI Layout (Case 1)
  AUTHOR:  Jeff Howarth
  DATE:    2/22/2022

  Purpose: To make an app layout when images are either global or
...
// Put images generated from script into config dictionary.

config.image_t1 = updateImage(config.s2_t1[0], config.s2_t1[1]);
config.image_t2 = updateImage(config.s2_t2[0], config.s2_t2[1]);

// OPTION 2

// Put images stored as assets into config dictionary.

config.image_t1_asset = ee.Image('projects/ee-primer/assets/S2_Middlebury_Spring_2021');
config.image_t2_asset = ee.Image('projects/ee-primer/assets/S2_Middlebury_Fall_2021');
...
leftMap.addLayer(
    config.image_t1_asset,
    config.s2_viz,
    'April - May 2020 Asset',
    false);
...
rightMap.addLayer(
    config.image_t2_asset,
    config.s2_viz,
    'August - Sept 2020 Asset',
    false)
  ;
...
var places =
  {
    ...
    'Cornwall Swamp': [-73.188244,43.930298, 13],
    'Salisbury Swamp': [-73.131060,43.881270, 13]
  }
;
